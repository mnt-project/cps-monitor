<div class="container">
    <div class="row border-bottom">
        <x-switch-button :flag="$user->settings->notifications" :route="route('user.notifications',$user)">Notifications</x-switch-button>
    </div>
    <div class="row border-bottom">
        <x-switch-button :flag="$user->settings->hidden" :route="route('user.hidden',$user)" labeltrue="Hidden" labelfalse="Public">Profile type</x-switch-button>
    </div>
    <div class="row border-bottom">
    ...
    <div class="row border-bottom">
        ...
        <div class="col-lg-6 col-md-8 col-sm-6 text-lg-start my-5">
            <form method="post" action={{ route('user.avatar',\Illuminate\Support\Facades\Auth::id()) }} enctype="multipart/form-data">
                @csrf
