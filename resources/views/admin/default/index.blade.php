        ...
        <div class="col-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                @for($i = 0; $i < sizeof($names); $i++)
                    <li><a class="dropdown-item {{($i == $sort) ? 'active' : ''}}" href="{{route('admin.community',['tabid'=>$tabid,'sort'=>$i,'view'=>$view])}}">{{ $names[$i] }}</a></li>
                @endfor
            </ul>
        </div>
        <div class="col-8">
        ...
        <div class="col-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                @for($i = 0; $i < sizeof($viewnames); $i++)
                    <li><a class="dropdown-item {{($i == $view) ? 'active' : ''}}" href="{{route('admin.community',['tabid'=>$tabid,'sort'=>$sort,'view'=>$i])}}">{{ $viewnames[$i] }}</a></li>
                @endfor
            </ul>
        </div>
    </div>
